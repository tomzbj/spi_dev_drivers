...
void LCD12832_Init(lcd12832_cfg_t* cfg)
{
    g = *cfg;
    g.reset_f(0);
    _delay_ms_loop(50);
    ...
    WriteCmd(0x23);                 // contrast coarse adjust
    WriteCmd(0x81);                 // contrast fine adjust
    WriteCmd(0x12);                 // contrast value (0x00 ~ 0x3f)
